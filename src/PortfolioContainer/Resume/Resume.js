...
const Resume = (props) => {
  ...
  const resumeDetails = [
    <div className="resume-screen-container" key="education">
      <ResumeHeading
        heading={"Collegio De Dagupan, Dagupan City"}
      ...
      <ResumeHeading
        heading={"KODEGO BOOTCAMP, PHILIPPINES"}
        subHeading={"A 3 MONTH(s) HANDS ON TRAINING WITH PHILIPPINES TOP BOOTCAMP. PH"}
        fromDate={" NOV, 2021"}
        toDate={" JAN, 2021"}
      />
      <ResumeHeading
        heading={"High School "}
        subHeading={"ARCHDIOCESSAN SCHOOL OF SAN FABIAN"}
        fromDate={"1998"}
        toDate={"2001"}
      />
    </div>,
